...
This vault is the **reusable configuration** of a personal Obsidian vault used for organizing life and taking active recall notes. To clarify, the active recall notes are for consolidating knowledge. For learning notes, (lectures, courses, etc) check out my Claude based workflow at https://github.com/amcwong/claude-code-my-workflow which is a fork of pedrohcgs's workflow.
